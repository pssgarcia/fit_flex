...
export function Amenities() {
	return (
		<section className="bg-white py-10 lg:py-20 flex flex-col gap-y-10" id="amenities">
			<article className="flex flex-col items-center gap-y-5 lg:gap-y-7">
				<h2 className="font-bold text-3xl md:text-5xl">Amenities</h2>
				<p className="w-80 md:w-11/12 lg:w-9/12 text-center text-lg lg:text-2xl md:text-xl text-gray-700">
			...
			<section className="flex flex-col md:flex-row md:flex-wrap justify-center items-center gap-6 lg:gap-10">
